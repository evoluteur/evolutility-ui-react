...
export default class Footer extends React.PureComponent {
    ...
    render() {
        return <div className="Footer" role="contentinfo">
            <a className="copyright" target="ui" rel="noopener noreferrer" href="https://github.com/evoluteur/evolutility-ui-react"><span>Evolutility-UI-React v{version}</span></a>
