// Evolutility-UI-React :: /views/Charts/Charts.tsx
  ...
  if (m) {
    ...
    return (
      <div className={`evol-charts model_${entity}`}>
        <ViewHeader entity={entity as string} title={title} view="charts" />
        <ErrorBoundary>
