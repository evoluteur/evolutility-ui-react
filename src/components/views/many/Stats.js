            ...
            <div className="fl-stats">
              ...
              {k.avg
                ? itemAggr(
                    k.id + "avg",
                    i18n_stats.avg,
                    formattedValue(format.decimalString(k.avg), k.field)
                  )
                : null}
              {k.min === k.max ? (
                itemAggr(
                  k.id + "min-max",
                  i18n_stats.min + " = " + i18n_stats.max,
              ...
              <div>
                {k.chartable && this.state[k.field.id + "_Chart"] ? (
                  <Chart
                    ...
                    field={k.field}
                    title={
                      format.capitalize(model.namePlural) +
                      " / " +
                      k.field.label
                    }
                    type="bars"
