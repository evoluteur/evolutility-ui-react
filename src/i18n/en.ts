...
export const i18n_nav: Record<string, string> = {
...
export const i18n_actions: Record<string, string> = {
  browse: "Browse",
  edit: "Edit",
  new: "New",
...
// --- status ---
export const i18n_msg: Record<string, string> = {
...
// --- validation ---
export const i18n_validation: Record<string, string> = {
...
// --- upload ---
export const i18n_upload: Record<string, string> = {
...
// --- charts ---
export const i18n_charts: Record<string, string> = {
  dash: "{0} Dashboard",
...
// --- comments ---
export const i18n_comments: Record<string, string> = {
  comment: "comment",
  comments: "comments",
};

export const i18n_stats: Record<string, string> = {
...
export const i18n_activity: Record<string, string> = {
...
export const i18n_errors: Record<string, string> = {
  error: "Error",
...
export const i18n_404: Record<string, string> = {
