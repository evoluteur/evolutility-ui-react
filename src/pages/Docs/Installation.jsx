        ...
        <li>
          ...
          <div className="rels">
            ...
            <div>
              ...
              <ul>
                <li>
                  comics (Array): comics_language / id =&gt; comics /
                  language_id
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul>
                <li>
                  category (Object): contact / category_id -&gt;
                  contact_category / id
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul>
                <li>
                  artist (Object): music_album / artist_id -&gt; music_artist /
                  id
                </li>
                <li>
            ...
            <div>
              ...
              <ul>
                <li>
                  albums (Array): music_artist / id -&gt; music_album /
                  artist_id
                </li>
              </ul>
            </div>
