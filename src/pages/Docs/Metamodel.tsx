...
import type { ObjectMeta, PropMeta } from "./docMetadata";

import "./Doc.scss";

const propsTable = (props: PropMeta[]) => (
...
const section = (info: ObjectMeta, intro?: ReactNode, footer?: ReactNode) => (
  <section>
    <div className="anchor">
      <a id={info.title.replaceAll(" ", "_")}></a>
    </div>
    <h2>{info.title}</h2>
      ...
      {section(
        ...
        <p>
          ...
          <a
            ...
            href="https://github.com/evoluteur/evolutility-ui-react/blob/main/src/models/organizer/winecellar.ts"
          >
            Wine Cellar
          </a>
          .
