...
const sortById = (a: PropMeta, b: PropMeta) => a.id.localeCompare(b.id);

export const objectMeta: ObjectMeta = {
  id: 1,
  icon: "/doc/object.png",
  name: "object",
  namePlural: "objects",
...
export const fieldMeta: ObjectMeta = {
  id: 2,
  icon: "/doc/field.png",
  name: "field",
  namePlural: "fields",
  ...
  props: [
    ...
    },
    {
      id: "type",
      description:
        "Field type to show in the UI. Possible field types: <ul><li>boolean (yes/no)</li><li>date</li><li>decimal</li><li>document</li><li>email</li><li>image</li><li>integer</li><li>json</li><li>lov (list of values)</li><li>money</li><li>text</li><li>textmultiline</li><li>time</li><li>url</li></ul>",
      ui: true,
      db: true,
    },
    {
...
export const collecMeta: ObjectMeta = {
  id: 3,
...
export const fieldGroupMeta: ObjectMeta = {
  id: 4,
...
export const viewDoc: Record<"one" | "many" | "comfort", ViewDocItem[]> = {
  one: [
    {
      id: "browse",
      name: "Browse",
